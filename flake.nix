  ...
  outputs = { self, nixpkgs, import-cargo }:
    ...
    in {
      ...
      overlays.default = final: prev: {
        ...
        rustynixspike = with final; final.callPackage ({ inShell ? false }: final.rustPlatform.buildRustPackage rec {
		...
		version = "0.1.0";
          ...
          cargoSha256 = "sha256-odcOQu12jzHrMit2nnQubAhg7pb50jNGtcw0/Iyda0s=";
        }) {};
